defmodule RSMP.Registry do
  ...
  def via_channel(id, code, channel_name), do: via({id, :channel, code, channel_name})
  ...
  def lookup_channel(id, code, channel_name), do: lookup({id, :channel, code, channel_name})
