defmodule RSMP.Registry do
  ...
  def via_channel(id, module, code, channel_name, component), do: via({id, :channel, module, code, channel_name, component})
  ...
  def lookup_channel(id, module, code, channel_name, component), do: lookup({id, :channel, module, code, channel_name, component})
